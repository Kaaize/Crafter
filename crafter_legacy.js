async function carregarReceitas() {
    try {
        ...
        function atualizarIngredientes() {
            ...
            caption.innerHTML = `
                <div>Ingredientes Totais</div>
                <div style="font-size: 0.8em; color: #aaa; margin-top: 4px; display: flex; flex-direction: column; gap: 2px;">
                    <span>Custo: $${valorTotal}</span>
                    <span>Slots Necessários: ${slotInventario}</span>
                </div>
            `;
        }
